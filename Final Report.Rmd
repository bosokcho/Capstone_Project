...
For all our models we ran Markov chains in order to simulate the posterior results after running our models in rjags.A Markov Chain is a chain of approximated values where one value is predicted by the value just prior to it.
