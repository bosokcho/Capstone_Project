...
Our final model attempted to model the duration of the hurricane by total number of days the hurricane lasted.
```{r echo=FALSE}
...
library(marmap)
EQU.24N <- getNOAA.bathy(lon1 = 100, lon2 = 70, lat1 = 0, lat2 = 24, resolution = 10)
plot(EQU.24N)
