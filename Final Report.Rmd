...
In order to answer four different research questions, we decided to used two different Bayesian modeling: A normal-normal model and Poisson regression model.
