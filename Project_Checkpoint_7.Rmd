...
running_mean_plot(x=freq_sample_small$beta3, se=TRUE)
```
...
Get landfall data
But what about the coordinates
Also we need temperature data by locations
...
Poisson regression
```{r}
temp.glm = glm(total~ temp, family="poisson", data=hurricanes_per_zone)
summary(temp.glm)
